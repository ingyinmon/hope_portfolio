import { images } from "./ImageFutures";
    ...
    <>
      <section className="grow w-full h-[450px] p-4 mt-16">
        ...
        <div className="flex items-center relative">
          ...
          <div className="future-prev absolute top-1/2 left-7 -translate-y-1/2 cursor-pointer z-50">
            <img src={leftArrow} alt="prev" className="w-13 h-13" />
          </div>
          <div className="future-next absolute top-1/2 right-7 -translate-y-1/2 cursor-pointer z-50">
