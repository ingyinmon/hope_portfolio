import { images } from "./ImageManipulation";
      ...
      <section className="grow w-full h-[450px] p-4 mt-10">
        ...
        <div className="flex items-center relative">
          <Swiper
            ...
            loop={true}
            navigation={{
              prevEl: ".manipulation-prev",
              nextEl: ".manipulation-next",
            }}
            breakpoints={{
              0: {
                slidesPerView: 1.2,
          ...
          >
            {images.map((img, index) => (
              <SwiperSlide key={index}>
                <div
                  onClick={() => navigate(`/manipulation/${index}`)}
                  className="
                   w-[220px] h-[330px]
...
export default DesignManipulation;
